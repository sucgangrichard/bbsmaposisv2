...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <!-- Right navbar links -->
    <ul class="navbar-nav ml-auto">
      <li class="nav-item"><span class="time-display d-none d-md-inline">
        <a class="nav-link">
          <i class="nav-icon fas fa-clock"></i>
          <strong>Login Time:</strong> <span style="font-weight: bold;"><?php echo $_SESSION['login_time']; ?></span>
        </a></span>
      </li>    <li class="nav-item">
        <a class="nav-link">
          <i class="nav-icon fas fa-clock"></i>
          <strong>Current Time:</strong> <span id="current-time" style="font-weight: bold;"></span>
        </a>
      </li>
    
    <?php
    include_once "conndb.php";
// Fetch products with insufficient stock
$sql = "SELECT product_name FROM tbl_mmenu WHERE available < 10";
...
<li class="nav-item dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        <span class="dropdown-header"><?php echo count($notifications); ?> Notifications</span>
        <div class="dropdown-divider"></div>
        <?php foreach ($notifications as $notification): ?>
            <a href="#" class="dropdown-item">
                <i class="fas fa-exclamation-triangle mr-2"></i> <?php echo $notification['product_name']; ?> stock is insufficient
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="./iconspng/user (2).png" class="img-circle" alt="User Image">
        </div>
        <div class="info">
