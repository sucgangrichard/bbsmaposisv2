...
<div class="btn-group">
    ...
    <a href="useredit_dine_in.php?id='.$row->invoice_id.'" class="btn btn-info " role="button" onclick="return checkPassword('.$row->invoice_id.', \'useredit_dine_in.php?id='.$row->invoice_id.'\')"><span class="fa fa-edit" style="color:#ffffff" data-toggle="tooltip" title="Edit Order"></span></a>
