...
<script>
    ...
    function labelFormatter(label, series) {
      return '<div style="font-size:12pt;text-align:center;padding:5px;color:#85d4e3;font-weight:bold;font-family:Arial, sans-serif;text-shadow: 1px 1px 2px black;">' +
