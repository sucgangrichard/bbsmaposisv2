...
// Call the function to check stock levels with both arguments
checkStockLevels($pdo, $intervalInSeconds);
...
<!--
          ...
          <li class="nav-item">
            <a href="deletadatas.php" class="nav-link">
...
function checkStockLevels() {
    fetch('emailnotif.php')
        .then(response => response.json())
        .then(data => {
            console.log(data); // Handle the stock levels data
            // You can add code here to display notifications
        })
        .catch(error => console.error('Error:', error));
}

// Fetch the interval from the server
fetch('notiffsettings.php?ajax=true')
    .then(response => response.json())
    .then(data => {
        const intervalInSeconds = data.intervalInSeconds;
        // Check stock levels at the specified interval
        setInterval(checkStockLevels, intervalInSeconds * 1000);
    })
    .catch(error => console.error('Error:', error));
</script>